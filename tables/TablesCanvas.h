...
class TablesCanvas : public CanvasControllerDeclarative, public SearchingInterface, public ProcessInputInterface
{
    Q_OBJECT
...
public:
    explicit TablesCanvas(QDeclarativeItem* parent = 0);
    virtual ~TablesCanvas();
